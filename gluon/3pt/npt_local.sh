...
# JK: THIS IS WHERE A CHROMA CALL FOR THE GLUON OPERATORS BELONGS
...
#########################
${PYDIR}/redstar_3pt_gluon.py -c $CFG -e $ENSEM -i $nucOps -f $nucOps \
...
/global/homes/j/jkarpie/run_scripts/gluon/3pt/run_redstar_int.2pt.no-nodes.sh \

...
${here}/npt_generator.sh $T 0 0 0 $cfg 0.00 $stream
${here}/npt_generator.sh $T 0 1 0 $cfg 0.00 $stream

for pz in {1..3}
do

${here}/npt_generator.sh $T 0 0 \$pz $cfg 0.00 $stream
${here}/npt_generator.sh $T 0 1 \$pz $cfg 0.00 $stream

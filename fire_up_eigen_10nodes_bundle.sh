...
./fire_up_peram_320nodes_cfg_T_bundle_zeta.sh ${cfg} $stream \$PBS_JOBID
./fire_up_peram_320nodes_cfg_T_bundle_zeta.sh $((cfg+50)) $stream \$PBS_JOBID

#for ccc in `seq ${cfg} 10 $((cfg+90))` ; do ./fire_up_peram_64nodes_bundle_zeta.sh \$ccc $stream \$PBS_JOBID ; done

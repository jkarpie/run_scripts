...
/global/homes/j/jkarpie/run_scripts/gluon_a0p094_mpi280/make_peram_xml_zeta_all_T_strange.sh \
...
srun -N1 -n4 -c16  $chroma -i ${scratch_dir}/xml/\${name_stem}.ini.xml -o ${scratch_dir}/xml/\${name_stem}.out.xml  -pool-max-alignment 512 -pool-max-alloc 0 -geom 1 1 1 4 &

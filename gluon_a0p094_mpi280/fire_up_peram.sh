...
name_stem="peram_bundle_${cfg}_z${zeta}_T${T}"
...
cat <<EOF > ${filename}
#!/bin/bash
#SBATCH -o out_peram_${cfg}_z${zeta}_T${T}
...
/global/homes/j/jkarpie/run_scripts/gluon/make_peram_xml_zeta.sh \
      ...
      ${scratch}/cl21_32_64_b6p3_m0p2350_m0p2050_extension/${ensemb}-${stream}/peram/${cfg}/${ensemb}-${stream}_z${zeta}_light_peram.${cfg}.T${T}.peram \
      $T \
      $zeta 

mkdir -p ${scratch}/cl21_32_64_b6p3_m0p2350_m0p2050_extension/${ensemb}-${stream}/peram/${cfg}/

if [ -f ${scratch}/cl21_32_64_b6p3_m0p2350_m0p2050_extension/${ensemb}-${stream}/peram/${cfg}/${ensemb}-${stream}_z${zeta}_light_peram.${cfg}.T${T}.peram ]
then
rm ${scratch}/cl21_32_64_b6p3_m0p2350_m0p2050_extension/${ensemb}-${stream}/peram/${cfg}/${ensemb}-${stream}_z${zeta}_light_peram.${cfg}.T${T}.peram
fi

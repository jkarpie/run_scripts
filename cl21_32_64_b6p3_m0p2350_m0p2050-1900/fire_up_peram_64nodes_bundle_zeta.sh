...
file_s=${file_stem}_z\${zeta}_light.${cfg}.T\${T}
...
./make_peram_xml_zeta.sh xml/\${file_s}.ini.xml \$cfg_file \${eig_file} /lus/grand/projects/SpectStructHadron/${cfg_stem}/${cfg_stem}-${stream}/peram/${cfg}/\${file_s}.peram \$T \$zeta

...
scratch_dir="/users/karpiejo/scratch/CLS_Nf2/E5/da_runs/"
mkdir -p ${scratch_dir}/sub
mkdir -p ${scratch_dir}/xml
mkdir -p ${scratch_dir}/out

mkdir -p "/users/karpiejo/scratch/CLS_Nf2/E5/mes_2pt/${cfg}"
...
rho="2.0"
/users/karpiejo/run_scripts/chroma_python/pseudo_da_cls_bundle_E5.py \
     -g "/users/karpiejo/scratch/CLS_Nf2/E5/cfgs/64x32x32x32b5.30k0.13625c1.90952id9n" \
     -k 2 -c $cfg -r \${rho} -p 8 \
     -s "/users/karpiejo/scratch//CLS_Nf2/E5/mes_2pt/" \
